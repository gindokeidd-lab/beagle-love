...
const slides = [
  ...
  },
  {
    ...
    title: 'ビーグルってどんな犬？',
    body: [
      '明るく、人なつっこく、食べることが大好きな犬です。',
      '匂いを嗅ぐことも大好き。もともとはイギリスで発展したハウンド犬です。',
      'アメリカでも根強い人気があり、AKC 2025年人気犬種ランキングでは7位です。',
      'AKCはAmerican Kennel Clubの略で、アメリカの主要な純血犬登録団体です。',
    ],
  },
  {
    ...
    title: '5つの可愛い',
    body: [
      '1. 食べ物への愛が全力すぎる。薬まで美味しそうに食べることも。',
      '2. 人も犬も大好き。誰にでも懐きにいく明るさが魅力。',
      '3. 実は鼻のプロ。検疫探知犬にもなる実力派。',
      '4. オシャレな模様と、草むらでも見つけやすい筆みたいなしっぽ。',
      '5. 笑顔で外へ連れ出してくれる、元気な相棒。',
    ],
  },
  {
    label: '03 / CHALLENGES',
    title: '3つの大変ポイント',
    body: [
      '1. 可愛すぎる遠吠え。でもよく通る声なので、躾はしっかり。',
      '2. 長すぎるクン活。本人は新聞を読んでいるつもり。',
      '3. イタズラ大好き。困る日もあるけれど、そこもビーグルらしさ。',
      '可愛いだけでなく、大変さも知っておくと暮らしやすくなります。',
    ],
  },
  {
    ...
    body: [
      '明るくて人なつっこい相棒と暮らしたい人。',
      '散歩やアウトドアを一緒に楽しみたい人。',
      '食いしん坊で、ちょっとお茶目な犬に惹かれる人。',
      '遠吠えやクン活などの個性も、楽しく向き合いたい人。',
    ],
  },
  {
    label: '05 / SUMMARY',
    ...
    body: [
      'ご飯も、人も、犬も、匂いの世界も大好き。',
      '元気で、表情豊かで、毎日を少し外へ連れ出してくれる犬です。',
      'ビーグルという幸せを、誰かにも少しだけ広げてみませんか。',
    ],
