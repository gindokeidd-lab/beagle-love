...
const statusCards = [
  {
    ...
    label: 'アメリカで根強い人気',
    value: 'AKC 2025年 7位',
    text: 'AKC（American Kennel Club：アメリカの主要な純血犬登録団体）の2025年人気犬種ランキングで、ビーグルは7位。親しみやすさは今も健在です。',
  },
  {
    icon: PawPrint,
    label: '日本での登録',
    value: 'JKC 2025年 27位 / 1,973頭',
    text: 'JKCの犬籍登録では2025年に1,973頭。これは飼育総数ではなく、その年に新規登録された頭数です。',
  },
  {
    icon: Sparkles,
    label: '鼻のプロとして活躍',
    value: '検疫探知犬にもなる実力派',
    text: '動植物検疫探知犬として、ビーグルは匂いを見つける力で人の暮らしを支えています。',
  },
];
